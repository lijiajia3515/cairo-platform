db.getCollection("auth_tenant_app_user_login_log").drop();
        ...
        $jsonSchema: {
            ...
            properties: {
                ...
                errMsg: {
                    ...
                    title: "错误原因",
                    description: "必填（可为 null），字符串，失败时的错误信息"
                },
                ip: {
                    bsonType: [
                        "null",
                ...
                agent: {
                    ...
                    title: "原始agent",
                    description: "必填（可为 null），字符串，原始 User-Agent"
                },
                os: {
                    bsonType: [
                        "null",
...
db.getCollection("auth_tenant_app_user_login_log").createIndex({
    logId: NumberInt("-1")
}, {
