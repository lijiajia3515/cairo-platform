db.getCollection("auth_tenant_app_user").drop();
db.createCollection("auth_tenant_app_user", {
    validator: {
        $jsonSchema: {
            title: "企业应用级用户",
            description: "企业应用级用户",
            properties: {
                ...
                roleIds: {
                    ...
                    title: "角色标识",
                    description: "可空，字符串数组，关联角色的唯一标识数组"
                },
                position: {
                    bsonType: [
                        "null",
...
db.getCollection("auth_tenant_app_user").createIndex({
...
db.getCollection("auth_tenant_app_user").createIndex({
    ...
    name: "ix_tenantId_appId_accountId_unique",
    background: true,
    unique: true,
...
db.getCollection("auth_tenant_app_user").createIndex({
    ...
    name: "ix_tenantId_appId_userId_unique",
    background: true,
    unique: true
});
