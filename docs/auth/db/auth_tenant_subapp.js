db.getCollection("auth_tenant_subapp").drop();
db.createCollection("auth_tenant_subapp", {
    validator: {
        $jsonSchema: {
            title: "企业子应用",
            description: "企业子应用",
...
db.getCollection("auth_tenant_subapp").createIndex({
    tenantId: NumberInt("1"),
    appId: NumberInt("1"),
    endpointId: NumberInt("1"),
    subappId: NumberInt("1")
}, {
    name: "ix_tenantId_appId_endpointId_subappId_unique",
    background: true,
    unique: true
});
