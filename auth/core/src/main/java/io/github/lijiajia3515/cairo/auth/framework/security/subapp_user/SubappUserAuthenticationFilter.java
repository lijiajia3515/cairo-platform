 ...
 */
public class SubappUserAuthenticationFilter extends OncePerRequestFilter {
	...
	private SubappUserAuthenticationTokenResolver subappUserAuthenticationTokenResolver = new SubappUserAuthenticationTokenResolver();
	 ...
	 */
	public SubappUserAuthenticationFilter(
	 ...
	 */
	public SubappUserAuthenticationFilter(AuthenticationManager authenticationManager) {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		SubappUserAuthenticationTokenRequest authenticationRequest;
		try {
			authenticationRequest = this.subappUserAuthenticationTokenResolver.resolve(request);
		}
		catch (AuthenticationException invalid) {
			this.logger.trace("Sending to authentication entry point since failed to resolve app subapp user token", invalid);
	 ...
	 * @param subappUserAuthenticationTokenResolver the {@code BearerTokenResolver} to use
	 */
	public void setSubappUserAuthenticationTokenResolver(SubappUserAuthenticationTokenResolver subappUserAuthenticationTokenResolver) {
		Assert.notNull(subappUserAuthenticationTokenResolver, "bearerTokenResolver cannot be null");
		this.subappUserAuthenticationTokenResolver = subappUserAuthenticationTokenResolver;
	}
