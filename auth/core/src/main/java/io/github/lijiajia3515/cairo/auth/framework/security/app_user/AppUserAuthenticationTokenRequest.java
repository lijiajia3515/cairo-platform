 ...
 * @since 5.1
 */
public class AppUserAuthenticationTokenRequest extends AbstractAuthenticationToken {
	...
	public AppUserAuthenticationTokenRequest(String appId, String endpointId, String token) {
