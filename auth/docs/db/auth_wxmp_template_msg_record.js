db.getCollection("auth_wxmp_template_msg_record").drop();
db.createCollection("auth_wxmp_template_msg_record", {
    validator: {
        $jsonSchema: {
            title: "微信模板消息记录",
            ...
            properties: {
                ...
                source: {
                    ...
                    title: "来源",
                    description: "可空，字符串，来源标识"
                },
                text: {
                    bsonType: "string",
                    title: "微信消息文本",
                    description: "必填，字符串，文本内容"
                },
                bizArgs: {
                    bsonType: [
                        "null",
...
db.getCollection("auth_wxmp_template_msg_record").createIndex({
    appId: NumberInt("1"),
    wxmpProviderId: NumberInt("1"),
    bizId: NumberInt("1")
}, {
    name: "ix_appId_wxmpProviderId_bizId"
});
db.getCollection("auth_wxmp_template_msg_record").createIndex({
    msgId: NumberInt("1")
}, {
