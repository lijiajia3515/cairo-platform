db.getCollection("auth_tenant_app_department_template").drop();
db.createCollection("auth_tenant_app_department_template", {
    validator: {
        $jsonSchema: {
            title: "企业部门模板",
            description: "企业部门模板",
            properties: {
                ...
                tenantAppDepartmentTemplateName: {
                    bsonType: [
                        "null",
                        "string"
                    ],
...
db.getCollection("auth_tenant_app_department_template").createIndex({
    appId: NumberInt("1")
}, {
    name: "ix_appId",
    background: true
