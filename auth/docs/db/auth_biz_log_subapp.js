db.getCollection("auth_biz_log_subapp").drop();
db.createCollection("auth_biz_log_subapp", {
    validator: {
        $jsonSchema: {
            title: "子应用业务日志",
            description: "子应用业务日志",
...
db.getCollection("auth_biz_log_subapp").createIndex({
    logId: NumberInt("-1")
}, {
...
db.getCollection("auth_biz_log_subapp").createIndex({
    ...
    name: "ix_appId_endpointId_subappId_userId",
    background: true
});
