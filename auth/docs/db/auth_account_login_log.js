db.getCollection("auth_account_login_log").drop();
db.createCollection("auth_account_login_log", {
    validator: {
        $jsonSchema: {
            title: "账号登录日志",
            description: "账号登录日志",
            properties: {
                ...
                accountTokenId: {
                    ...
                    title: "账号TokenId",
                    description: "必填（可为 null），字符串，账号令牌唯一标识"
                },
                authType: {
                    bsonType: "string",
                    title: "认证方式",
...
db.getCollection("auth_account_login_log").createIndex({
