...
public class PublicFileClientApiFallbackFeignClient implements PublicFileClientApiFeignClient {
	public static final RuntimeException EX = new ErrorBusinessException("系统服务-公开文件子应用故障");
