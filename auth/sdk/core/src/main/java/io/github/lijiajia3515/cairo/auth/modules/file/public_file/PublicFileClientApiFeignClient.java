 ...
 */
@FeignClient(
	contextId = "publicFileClientApiFeignClient",
	name = "${cairo.feign.client.cairo-auth-service:cairo-auth-service}",
	path = "/client_api/public_file",
	fallbackFactory = PublicFileClientApiFeignClientFallbackFactory.class,
	configuration = CairoAuthClientSdkCoreFeignClientConfiguration.class
)
public interface PublicFileClientApiFeignClient {
	/**
	 * 访问文件
	 * 需要权限： public_file:all｜public_file:access_file
	 *
	 * @param args 参数
	 * @return 带签名的文件地址
	 */
	...
	/**
	 * 获取文件状态
	 * 需要权限： public_file:all｜public_file:get_file_stat
	 *
	 * @param args 参数
	 * @return 文件状态列表
	 */
	...
	/**
	 * 上传文件
	 * 需要权限： public_file:all｜public_file:upload_file
	 *
	 * @param path 上传路径
	 * @param file 文件
	...
	/**
	 * 删除文件
	 * 需要权限： public_file:all｜public_file:delete_file
	 *
	 * @param args 参数
	 */
