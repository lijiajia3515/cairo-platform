package io.github.lijiajia3515.cairo.auth.modules.tenant_app_user.tenant_app_user;
...
public class CairoTenantAppUserRequestTool {
	...
	/**
	 * 获取基础企业应用级用户map，根据tenant metadata mongodb
	 *
	 * @param tenantId 企业ID
	 * @param appId    应用ID
	...
	/**
	 * 获取企业应用级用户map，根据user metadata mongodb
	 *
	 * @param tenantId     企业ID
	 * @param appId        应用ID
	 * @param metadata     metadata
