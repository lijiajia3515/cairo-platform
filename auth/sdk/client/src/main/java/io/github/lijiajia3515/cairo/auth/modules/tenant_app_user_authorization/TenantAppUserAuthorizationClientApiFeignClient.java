...
public interface TenantAppUserAuthorizationClientApiFeignClient {
	...
	ResponseEntity<BusinessResult<TenantAppUserAuthorizationModel>> getCustomTenantAppUserAuthorization(@RequestHeader(HttpHeaders.AUTHORIZATION) String authorization,
																														@RequestBody GetCustomTenantAppUserAuthorizationArgs args);
