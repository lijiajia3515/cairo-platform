...
public class AppFileClientApiFallbackFeignClient implements AppFileClientApiFeignClient {
	public static final RuntimeException EX = new ErrorBusinessException("系统服务-应用文件子应用故障");
