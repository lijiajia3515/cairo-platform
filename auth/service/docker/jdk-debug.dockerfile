...
# 安装字体
RUN apt install -y fontconfig ttf-dejavu ttf-wqy-zenhei
...
#依赖复制
ADD https://raw.githubusercontent.com/lionsoul2014/ip2region/master/data/ip2region.xdb ./ip2region/
...
ENTRYPOINT ["sh", "-c","exec java $JAVA_OPTS $JVM_OPTS org.springframework.boot.loader.JarLauncher"]
