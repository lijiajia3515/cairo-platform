...
public class WxmpAppUserAppUserApiController {

	private final WxmpAppUserAppUserApiService wxmpAppUserAppUserApiService;
	...
	public List<MyAppUserWxmp> getMyAppUserWxmp(@AuthenticationPrincipal CairoOAuthEndpointPrincipal principal) {
		...
		return wxmpAppUserAppUserApiService.getMyAppUserWxmp(clientId,userId);
	}*/
	...
	public Optional<String> bindAppUserWxmp(@Validated @RequestBody BindAppUserWxmpArgs args) {
		...
		wxmpAppUserAppUserApiService.bindAppUserWxmp(args);
	...
	public Optional<String> unbindAppUserWxmp(@Validated @RequestBody UnBindAppUserWxmpArgs args) {
		...
		wxmpAppUserAppUserApiService.unbindAppUserWxmp(args);
