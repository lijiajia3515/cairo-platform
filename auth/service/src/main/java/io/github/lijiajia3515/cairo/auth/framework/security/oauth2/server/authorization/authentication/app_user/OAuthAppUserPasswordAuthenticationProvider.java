...
public final class OAuthAppUserPasswordAuthenticationProvider implements AuthenticationProvider {
	 ...
	 * @since 0.2.3
	 */
	public OAuthAppUserPasswordAuthenticationProvider(AuthenticationManager authenticationManager, AppUserAuthorizationService authorizationService, OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator) {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		OAuthAppUserPasswordAuthenticationToken token = (OAuthAppUserPasswordAuthenticationToken) authentication;
		...
		if (registeredClient.getAuthorizationGrantTypes().contains(APP_USER_REFRESH_TOKEN) &&
			...
			if (log.isTraceEnabled()) {
				log.trace("Generated app endpoint endpoint user refresh token");
			}
	...
	public boolean supports(Class<?> authentication) {
		return OAuthAppUserPasswordAuthenticationToken.class.isAssignableFrom(authentication);
	}
