...
/**
 * [client/api] sns provider service
 */
@Slf4j
@Validated
@Component
public class SnsProviderClientApiService {

	private final MongoTemplate readMongoTemplate;
	private final AppCommonService appCommonService;
	private final SnsProviderProperties snsProviderProperties;

	public SnsProviderClientApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
