...
/**
 * [endpoint/api] app endpoint service
 */
@Slf4j
@Validated
@Component
public class EndpointEndpointApiService {

	private final MongoTemplate readMongoTemplate;
	private final AppCommonService appCommonService;

	public EndpointEndpointApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
