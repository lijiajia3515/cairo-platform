...
@BusinessResultBody
public class ClientTenantAppUserApiController {

	private final ClientTenantAppUserApiService clientTenantAppUserApiService;
	...
	public List<BasicClient> getCurrentEndpointList(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @RequestBody(required = false) GetCurrentAppClientArgs args) {
		...
		return clientTenantAppUserApiService.getCurrentAppClientList(principal.getAppId(), args);
	}
}
