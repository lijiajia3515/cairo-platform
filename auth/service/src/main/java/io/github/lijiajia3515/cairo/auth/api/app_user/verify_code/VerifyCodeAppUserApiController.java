...
@BusinessResultBody
public class VerifyCodeAppUserApiController {
	private final VerifyCodeAppUserApiService verifyCodeAppUserApiService;
	...
	public Optional<String> sendMyAccountPhoneNumberVerifyCode(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal) {
		verifyCodeAppUserApiService.sendMyAccountPhoneNumberVerifyCode( principal.getAppId());
