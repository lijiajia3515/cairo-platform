...
/**
 * [client/api] tenant app subapp service
 */
@Slf4j
@Validated
@Component
public class TenantSubappClientApiService {
	...
	public TenantSubappClientApiService(
	...
	private Criteria buildCriteria(String tenantId,String appId,GetTenantSubappArgs args) {
		...
		if (args.getEndpointId() != null) {
			subappCriteria.and(SubappMongodb.FIELD.ENDPOINT_ID).in(args.getEndpointId());
		}
