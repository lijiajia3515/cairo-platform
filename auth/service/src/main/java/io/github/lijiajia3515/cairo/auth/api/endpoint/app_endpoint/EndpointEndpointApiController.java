package io.github.lijiajia3515.cairo.auth.api.endpoint.endpoint;
...
import io.github.lijiajia3515.cairo.auth.domain.api.endpoint.endpoint.GetEndpointArgs;
...
@BusinessResultBody
public class EndpointEndpointApiController {

	private final EndpointEndpointApiService endpointEndpointApiService;
	...
	public List<Endpoint> getEndpointList(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal, @RequestBody(required = false) GetEndpointArgs args) {
		...
		return endpointEndpointApiService.getEndpointList(principal.getAppId(), args);
	}
}
