...
@BusinessResultBody
public class AuthCodeTenantAppUserApiController {
	private final AuthCodeTenantAppUserApiService authCodeTenantAppUserApiService;
	...
	public AuthCodeModel getAuthCodeByVerifyPassword(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal userPrincipal,
		...
		args.setIp(ip);
		return authCodeTenantAppUserApiService.verifyPassword(accountId, tenantId, appId, args);
	}
}
