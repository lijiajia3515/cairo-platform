...
/**
 * [tenant_subapp_user/api] menu service
 */
@Slf4j
@Service
@Validated
public class MenuTenantSubappApiService {
	...
	public MenuTenantSubappApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate) {
