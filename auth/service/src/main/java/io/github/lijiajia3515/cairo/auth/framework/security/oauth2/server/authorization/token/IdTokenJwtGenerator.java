...
/**
 * Id Token Jwt Generator
 */
public final class IdTokenJwtGenerator implements OAuth2TokenGenerator<Jwt> {
	 ...
	 */
	public IdTokenJwtGenerator(JwtEncoder jwtEncoder) {
	...
	public Jwt generate(OAuth2TokenContext context) {
		if (context.getTokenType() == null || !OidcParameterNames.ID_TOKEN.equals(context.getTokenType().getValue())) {
			return null;
		}
		...
		Instant expiresAt = issuedAt.plus((Duration) registeredClient.getTokenSettings().getSettings().getOrDefault(CairoSettingNames.Token.ID_TOKEN_TIME_TO_LIVE, Duration.ofMinutes(30)));
