...
@BusinessResultBody
public class ClientAppUserApiController {

	private final ClientAppUserApiService clientAppUserApiService;
	...
	public List<BasicClient> getClientList(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal, @RequestBody(required = false) GetCurrentAppClientArgs args) {
		...
		return clientAppUserApiService.getClientList(principal.getAppId(), args);
	}
}
