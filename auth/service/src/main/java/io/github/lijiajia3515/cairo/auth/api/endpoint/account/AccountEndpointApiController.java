...
import io.github.lijiajia3515.cairo.auth.domain.api.endpoint.account.ModifyMyAccountAvatarUrlArgs;
...
@BusinessResultBody
public class AccountEndpointApiController {
	private final AccountEndpointApiService accountAppUserApiService;
