...
/**
 * [subapp_user/api] public app file service
 */
@Service
@Slf4j
public class PublicFileSubappApiService {
	...
	public PublicFileSubappApiService(MinioClient adminMinioClient, AsyncFileService asyncFileService, MinioProperties properties) {
	...
	public String accessFileUrl(@Valid @NotNull String s3Url, boolean enableVersion) {
		try {
			...
			log.debug("s3Url is fail : {}", e.getMessage());
			return DEFAULT_ACCESS_URL;
		}
	}
