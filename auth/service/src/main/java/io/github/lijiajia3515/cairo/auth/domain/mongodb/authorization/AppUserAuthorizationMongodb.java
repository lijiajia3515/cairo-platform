...
@AllArgsConstructor
@Builder
public class AppUserAuthorizationMongodb implements Serializable {
	...
	@AllArgsConstructor
	@SuperBuilder(toBuilder = true)
	public static class AccessToken extends AppUserAuthorizationMongodb.Token {
		/**
		 * 类型
		 */
		@Field(write = Field.Write.ALWAYS)
	...
	@NoArgsConstructor
	@SuperBuilder(toBuilder = true)
	public static class RefreshToken extends AppUserAuthorizationMongodb.Token {
