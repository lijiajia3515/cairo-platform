...
/**
 * [endpoint/api] app user login log controller
 */
@Slf4j
@Validated
@RestController
...
@BusinessResultBody
public class AppUserLoginLogAppUserApiController {

	private final AppUserLoginLogAppUserApiService appUserLoginLogAppUserApiService;
	...
	public Page<MyAppUserLoginLog> getMyAppUserLoginLogPageList(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal,
		...
		return appUserLoginLogAppUserApiService.getMyAppUserLoginLogPageList(appId, userId, Optional.ofNullable(args).orElse(GetMyAppUserLoginLogArgs.builder().build()));
	}
