...
public class AccountLoginLogMongodb implements Serializable {
	...
	public static class MongodbField extends AbstractAccountMetadataMongodbField {
		...
		public final String ACCOUNT_TOKEN_ID = field("accountTokenId");
		public final String AUTH_TYPE = field("authType");
