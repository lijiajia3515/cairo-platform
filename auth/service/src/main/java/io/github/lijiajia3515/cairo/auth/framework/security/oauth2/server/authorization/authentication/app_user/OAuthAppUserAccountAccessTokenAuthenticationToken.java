 ...
 */
@Getter
public class OAuthAppUserAccountAccessTokenAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	...
	protected OAuthAppUserAccountAccessTokenAuthenticationToken(String accountAccessToken, Set<String> scopes, Authentication clientPrincipal, Map<String, Object> additionalParameters) {
