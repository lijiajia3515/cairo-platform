package io.github.lijiajia3515.cairo.auth.api.tenant_endpoint.tenant_app_user_authorization;
...
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.tenant_app_user_authorization.GetMyTenantAppUserAuthorizationArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.tenant_app_user_authorization.OfflineMyTenantAppUserAuthorizationArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.tenant_app_user_authorization.RegisterDeviceArgs;
...
/**
 * [tenant_endpoint/api] tenant app endpoint user authorization controller
 */
@Slf4j
@Validated
@RestController
...
@BusinessResultBody
public class TenantAppUserAuthorizationTenantEndpointApiController {

	private final TenantAppUserAuthorizationTenantEndpointApiService tenantAppUserAuthorizationTenantEndpointApiService;
	...
	public List<TenantAppUserAuthorization> getMyTenantAppUserAuthorizationList(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		...
		return tenantAppUserAuthorizationTenantEndpointApiService.getMyTenantAppUserAuthorizationList(tenantId, appId, userId);
	}
	...
	public Page<TenantAppUserAuthorization> getMyTenantAppUserAuthorizationPageList(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @Validated @RequestBody(required = false) GetMyTenantAppUserAuthorizationArgs args) {
		...
		String appId = principal.getAppId();
		String userId = principal.getUserId();
		return tenantAppUserAuthorizationTenantEndpointApiService.getMyTenantAppUserAuthorizationPageList(tenantId, appId, userId, args);
	}
	...
	public Optional<String> registerMyDevice(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @Validated @RequestBody RegisterDeviceArgs args) {
		...
		tenantAppUserAuthorizationTenantEndpointApiService.registerMyTenantAppUserDevice(tenantId, appId, endpointId, userId, tokenId, args);
	...
	public Optional<String> offlineMyTenantAppUserAuthorization(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @Validated @RequestBody(required = false) OfflineMyTenantAppUserAuthorizationArgs args) {
		...
		String appId = principal.getAppId();
		String userId = principal.getUserId();
		tenantAppUserAuthorizationTenantEndpointApiService.offlineMyTenantAppUserAuthorization(tenantId, appId, userId, args);
		return Optional.empty();
	}
	...
	public Optional<String> logoutTenantAppUserAuthorization(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		...
		String appId = principal.getAppId();
		String tokenId = principal.getId();
		tenantAppUserAuthorizationTenantEndpointApiService.logoutTenantAppUserAuthorization(tenantId, appId, tokenId);
		return Optional.empty();
	}
