...
/**
 * [tenant_subapp_user/api] tenant app subapp controller
 */
@Slf4j
@Validated
@RestController
@RequestMapping("/tenant_subapp_user_api/tenant_subapp")
@CairoSecurity(type = CairoSecurityType.TENANT_SUBAPP_USER)
@RequiredArgsConstructor
@BusinessResultBody
public class TenantSubappTenantSubappApiController {

	private final TenantSubappTenantSubappApiService tenantSubappTenantSubappApiService;
	...
	public List<MetadataTenantSubapp> getTenantSubappList(@AuthenticationPrincipal CairoOAuthTenantSubappUserPrincipal principal,
																  @Validated @RequestBody GetTenantSubappArgs args) {
		String tenantId = principal.getTenantId();
		String appId = principal.getAppId();
		return tenantSubappTenantSubappApiService.getTenantSubappList(tenantId,appId,args);
	}
