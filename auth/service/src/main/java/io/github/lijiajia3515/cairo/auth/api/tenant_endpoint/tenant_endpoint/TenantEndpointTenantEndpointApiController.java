package io.github.lijiajia3515.cairo.auth.api.tenant_endpoint.tenant_endpoint;
...
@BusinessResultBody
public class TenantEndpointTenantEndpointApiController {

	private final TenantEndpointTenantEndpointApiService tenantEndpointTenantEndpointApiService;
	...
	public List<TenantEndpoint> getCurrentEndpointList(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @RequestBody(required = false) GetCurrentEndpointArgs args) {
		...
		return tenantEndpointTenantEndpointApiService.getCurrentTenantEndpointList(principal.getTenantId(), principal.getAppId(), args);
	}
