...
/**
 * [subapp_user/api] client service
 */
@Slf4j
@Validated
@Component
public class ClientSubappApiService {

	private final MongoTemplate readMongoTemplate;

	public ClientSubappApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate) {
