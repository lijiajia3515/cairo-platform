package io.github.lijiajia3515.cairo.auth.api.tenant_endpoint.wxmp.tenant_app_user;
...
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.wxmp.user.BindTenantAppUserArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.wxmp.user.UnBindTenantAppUserArgs;
...
public class WxmpTenantAppUserTenantEndpointApiController {

	private final WxmpTenantAppUserTenantEndpointApiService wxmpTenantAppUserTenantEndpointApiService;
	...
	public Optional<String> bindTenantAppUserSns(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @Validated @RequestBody BindTenantAppUserArgs args) {
		...
		wxmpTenantAppUserTenantEndpointApiService.bindTenantAppUser(tenantId,args);
	...
	public Optional<String> unbindTenantAppUserSns(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal,@Validated @RequestBody UnBindTenantAppUserArgs args) {
		String tenantId = principal.getTenantId();
		wxmpTenantAppUserTenantEndpointApiService.unbindTenantAppUser(tenantId,args);
		return Optional.empty();
	}
}
