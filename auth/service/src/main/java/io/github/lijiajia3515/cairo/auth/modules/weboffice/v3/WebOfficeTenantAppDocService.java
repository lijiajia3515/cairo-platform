...
import io.github.lijiajia3515.cairo.auth.domain.dto.tenant.TenantExtension;
...
import io.github.lijiajia3515.cairo.auth.api.client.tenant.TenantClientApiService;
...
@Slf4j
@Component
public class WebOfficeTenantAppDocService extends WebOfficeService {
	...
	public WebOfficeTenantAppDocService(TransactionTemplate transactionTemplate,
										@Qualifier("mongoTemplate") MongoTemplate mongoTemplate,
										@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
										CommonFileCommonService commonFileCommonService,
										TenantClientApiService tenantClientApiService,
		...
		this.tenantClientApiService = tenantClientApiService;
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:get_tenant_app_doc_file",
		scope = "read",
		params = {
	...
	public OfficeFileMongodb getTenantAppDocFile(String tenantId, String appId, String userId, String sourceFilePath) {
		Map<String, String> fileMap = FileTools.decodeS3Meta(sourceFilePath);
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
		...
		if (fileMongodb == null) {
			...
			String newS3Filepath = WebOfficeTool.officeS3FilePath(fileId, fileVersion, filename);
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:generate_tenant_doc_token",
		scope = "read",
		params = {
	...
	public WebOfficeDocToken generateTenantDocToken(String fileId, String type, boolean write, String tenantId, String appId, String userId) {
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_doc_file_info",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
			@BizLog.Param(key = "tenantId", value = "#tenantId"),
	...
	public WebOfficeFileResponse tenantAppDocFileInfo(String fileId, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
			.and(OfficeFileMongodb.FIELD.APP_ID).is(appId);
		...
		return WebOfficeFileResponse.builder()
			...
			.creatorId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, file.getCreateUserId()))
			.modifierId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, file.getUpdateUserId()))
			.build();
	}

	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_file_download_file",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
			@BizLog.Param(key = "tenantId", value = "#tenantId"),
	...
	public WebOfficeFileDownloadResponse tenantAppDocFileDownloadFile(String fileId, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_doc_permission_file",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
			@BizLog.Param(key = "tenantId", value = "#tenantId"),
	...
	public WebOfficeFilePermissionResponse tenantAppDocPermissionFile(String fileId, String write, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
		...
		return WebOfficeFilePermissionResponse.builder()
			.userId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, userId))
			.read(1)
			.update(writeFlag)
			.download(1)
			.rename(1)
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_doc_file_versions",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
	...
	public List<WebOfficeFileVersionResponse> tenantAppDocFileVersions(String fileId, int offset, int limit, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileVersionMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileVersionMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileVersionMongodb.FIELD.TENANT_ID).is(tenantId)
		...
		updateActiveFile(fileId, tenantId, appId);
		...
		return fileVersions.stream().map(x -> WebOfficeFileVersionResponse.builder()
			...
			.creatorId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, x.getCreateUserId()))
			.modifierId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, x.getUpdateUserId()))
			.build()
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_doc_file_version",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
	...
	public WebOfficeFileVersionResponse tenantDocFileVersion(String fileId, int version, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileVersionMongodb.FIELD.FILE_ID).is(fileId)
		...
		return WebOfficeFileVersionResponse.builder()
			...
			.creatorId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, fileVersion.getCreateUserId()))
			.modifierId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, fileVersion.getUpdateUserId()))
			.build();
	}

	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_download_file_version",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
	...
	public WebOfficeFileDownloadResponse tenantAppDocDownloadFileVersion(String fileId, int fileVersion, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileVersionMongodb.FIELD.FILE_ID).is(fileId)
	...
	@NewSpan
	public WebOfficeFileUploadPrepareResponse tenantDocPrepareUploadFile(String fileId, String appId, String tenantId, String userId) {
		return WebOfficeFileUploadPrepareResponse.builder()
			.digestTypes(Set.of("sha256"))
			.build();
	}

	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_upload_address_file",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
	...
	public WebOfficeFileUploadAddressResponse tenantAppUploadAddressFile(String fileId, WebOfficeFileUploadAddressRequest request, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_doc_complete_upload_file",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
			@BizLog.Param(key = "body", value = "#body"),
			@BizLog.Param(key = "tenantId", value = "#tenantId"),
			@BizLog.Param(key = "appId", value = "#appId"),
			@BizLog.Param(key = "userId", value = "#userId"),
		}
	)
	public WebOfficeFileResponse tenantAppDocCompleteUploadFile(String fileId, WebOfficeFileUploadCompleteRequest body, String tenantId, String appId, String userId) {
		try {
			...
			return WebOfficeFileResponse.builder()
				...
				.createTime((int) file.getMetadata().getCreateTime().toEpochSecond(ZoneOffset.ofHours(8)))
				.modifyTime((int) file.getMetadata().getUpdateTime().toEpochSecond(ZoneOffset.ofHours(8)))
				.creatorId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, userId))
				.modifierId(WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, userId))
				.build();
		} catch (RuntimeException e) {
			log.info("tenantAppDocCompleteUploadFile", e);
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_doc_watermark_file",
		scope = "read",
		params = {
			@BizLog.Param(key = "fileId", value = "#fileId"),
			@BizLog.Param(key = "body", value = "#body"),
	...
	public WebOfficeFileWatermarkResponse tenantAppDocWatermarkFile(String fileId, String tenantId, String appId, String userId) {
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
		...
		String name = null;
		try {
			Tenant tenantInfo = tenantClientApiService.getTenantInfo(
				GetTenantInfoArgs.builder()
					.tenantId(tenantId)
					.extension(Collections.singletonMap(CairoAuthExtensionConstants.TENANT, TenantExtension.BASIC.name()))
					.build()
			);
			if (tenantInfo != null && tenantInfo.getTenantName() != null && !tenantInfo.getTenantName().isBlank()) {
				name = tenantInfo.getTenantName();
			}
		} catch (RuntimeException e) {
			log.info("getTenant error", e);
		}
		if (name != null) {
			try {
	...
	@NewSpan
	@BizLog(
		bizId = "web_office_tenant_app_doc:tenant_app_doc_user_list",
		scope = "read",
		params = {
	...
	public List<WebOfficeUser> tenantAppDocUserList(List<String> userIds, String tenantId, String appId) {
		Set<String> cairoUserIds = userIds.stream().map(WebOfficeTool::webOfficeUserIdToTenantAppUser)
			.filter(Objects::nonNull)
			.map(CairoTenantAppUser::getUserId)
			.filter(Objects::nonNull)
			.collect(Collectors.toSet());
		if (cairoUserIds.isEmpty()) {
			return Collections.emptyList();
		}

		Map<String, TenantAppUser> basicuUserMap = tenantAppUserCommonService.getUserMapByUserIds(tenantId, appId, cairoUserIds);

		Map<String, TenantAppUser> userMap = basicuUserMap.values().stream()
			.collect(Collectors.toMap(x -> WebOfficeTool.tenantAppUserToWebOfficeUserId(tenantId, appId, x.getUserId()), x -> x));
		return userIds.stream()
			.map(x -> WebOfficeUser.builder()
				.id(x)
				.name(Optional.ofNullable(userMap.get(x)).map(TenantAppUser::getNickname).orElse(x))
				.avatarUrl(Optional.ofNullable(userMap.get(x)).map(TenantAppUser::getAccountAvatarUrl).orElse(DEFAULT_AVATAR_URL))
				.build()
			)
			.collect(Collectors.toList());
	}

	void updateActiveFile(String fileId, String tenantId, String appId) {
		Criteria criteria = Criteria
			.where(OfficeFileMongodb.FIELD.FILE_ID).is(fileId)
			.and(OfficeFileMongodb.FIELD.MODE).is(DocMode.TENANT_APP)
			.and(OfficeFileMongodb.FIELD.TENANT_ID).is(tenantId)
