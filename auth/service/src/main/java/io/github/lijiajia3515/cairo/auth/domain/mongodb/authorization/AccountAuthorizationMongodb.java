...
@AllArgsConstructor
@Builder
public class AccountAuthorizationMongodb implements Serializable {
	...
	@AllArgsConstructor
	@SuperBuilder(toBuilder = true)
	public static class AccessToken extends AccountAuthorizationMongodb.Token {
		/**
		 * 类型
		 */
		@Field(write = Field.Write.ALWAYS)
	...
	@NoArgsConstructor
	@SuperBuilder(toBuilder = true)
	public static class RefreshToken extends AccountAuthorizationMongodb.Token {
	...
	public static class MongodbField extends AbstractAccountMetadataMongodbField {
		...
		public final String ACCOUNT_NAME = field("accountName");
