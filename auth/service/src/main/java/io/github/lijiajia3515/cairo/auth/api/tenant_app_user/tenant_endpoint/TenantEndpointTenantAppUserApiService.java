...
@Validated
@Component
public class TenantEndpointTenantAppUserApiService {
	...
	public TenantEndpointTenantAppUserApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
