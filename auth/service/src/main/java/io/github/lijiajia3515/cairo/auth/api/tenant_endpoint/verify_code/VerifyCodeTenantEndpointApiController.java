package io.github.lijiajia3515.cairo.auth.api.tenant_endpoint.verify_code;
...
@BusinessResultBody
public class VerifyCodeTenantEndpointApiController {
	private final VerifyCodeTenantEndpointApiService verifyCodeTenantEndpointApiService;
	...
	public Optional<String> sendMyAccountPhoneNumberVerifyCode(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		verifyCodeTenantEndpointApiService.sendMyAccountPhoneNumberVerifyCode(principal.getTenantId(), principal.getAppId());
