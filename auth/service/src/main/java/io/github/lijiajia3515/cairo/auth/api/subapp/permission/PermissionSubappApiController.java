package io.github.lijiajia3515.cairo.auth.api.subapp.permission;
...
/**
 * [subapp_user/api] action permission
 */
@Slf4j
@Validated
@RestController
@RequestMapping("/subapp_user_api/permission")
@CairoSecurity(type = CairoSecurityType.SUBAPP_USER)
@RequiredArgsConstructor
@BusinessResultBody
public class PermissionSubappApiController {

	private final PermissionSubappApiService permissionSubappApiService;
	...
	public List<Permission> getElementList(@AuthenticationPrincipal CairoOAuthSubappUserPrincipal principal,
		...
		return permissionSubappApiService.getPermissionList(
			appId, endpointId,
	...
	@PreAuthorize("hasAnyAuthority('app_admin', 'permission:all', 'permission:read')")
	public Page<Permission> getPermissionPageList(@AuthenticationPrincipal CairoOAuthSubappUserPrincipal principal,
		...
		return permissionSubappApiService.getPermissionPageList(
			appId,
			endpointId,
			principal.getSubappId(),
			principal.getSubappVersion(),
