 ...
 * @since 5.0
 */
public class TokenKeyGenerator implements StringKeyGenerator {
	...
	public TokenKeyGenerator() {
		this(DEFAULT_KEY_LENGTH, DEFAULT_PREFIX);
	}
	 ...
	 */
	public TokenKeyGenerator(int keyLength, String prefix) {
		this(Base64.getEncoder(), keyLength, prefix);
	}
	 ...
	 */
	public TokenKeyGenerator(Base64.Encoder encoder) {
		this(encoder, DEFAULT_KEY_LENGTH, DEFAULT_PREFIX);
	}
	 ...
	 */
	public TokenKeyGenerator(Base64.Encoder encoder, int keyLength, String prefix) {
		if (encoder == null) {
	...
	public String generateKey() {
		...
		return prefix + new String(base64EncodedKey);
	}
