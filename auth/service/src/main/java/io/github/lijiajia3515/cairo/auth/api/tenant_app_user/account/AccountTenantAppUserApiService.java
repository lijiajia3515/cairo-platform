package io.github.lijiajia3515.cairo.auth.api.tenant_app_user.account;
...
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_app_user.account.ModifyMyAccountAvatarUrlArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_app_user.account.ModifyMyAccountPasswordArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_app_user.account.ModifyMyAccountPhoneNumberArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_app_user.account.ModifyMyAccountUsernameArgs;
...
/**
 * [tenant_endpoint/api] account service
 */
@Slf4j
@Validated
@Component
public class AccountTenantAppUserApiService {
	...
	public AccountTenantAppUserApiService(
		@Qualifier("mongoTemplate") MongoTemplate mongoTemplate,
		@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate, CairoAuthAccountService cairoAuthAccountService,
		AccountCommonService accountCommonService,
		TransactionTemplate transactionTemplate, PublicFileClientApiService publicFileClientApiService,
		RabbitTemplate rabbitTemplate,
		CairoRabbitmqTool cairoRabbitmqTool, ObjectMapper objectMapper,
	 ...
	 */
	@NewSpan
	@Lock4j(name = "modify_my_account_password", keyBuilderStrategy = TenantAppUserAuthKeyBuilder.class)
	@BizLog(
	...
	@SneakyThrows
	@Lock4j(name = "modify_my_account_avatar", keyBuilderStrategy = TenantAppUserAuthKeyBuilder.class)
...
//		}
	 ...
	 */
	@NewSpan
	@Lock4j(name = "modify_my_account_phone_number", keyBuilderStrategy = TenantAppUserAuthKeyBuilder.class)
	@BizLog(
	 ...
	 */
	@NewSpan
	@Lock4j(name = "modify_my_account_username", keyBuilderStrategy = TenantAppUserAuthKeyBuilder.class)
	@BizLog(
