 ...
 * customized via {@link #CairoPasswordEncoder(String, Map, String, String)}. If the
 ...
 * When matching it would delegate to {@link org.springframework.security.crypto.password.Pbkdf2PasswordEncoder}</li>
 ...
 * When matching it would delegate to {@link org.springframework.security.crypto.password.StandardPasswordEncoder}</li>
 * </ol>
 *
 ...
 */
public class CairoPasswordEncoder implements PasswordEncoder {
	 ...
	 */
	public CairoPasswordEncoder(String idForEncode, Map<String, PasswordEncoder> idToPasswordEncoder) {
	...
	public boolean upgradeEncoding(String prefixEncodedPassword) {
		// 因为 RegisteredClientRepository未提供更新密码的接口所以这里无法强制升级密码
		 return false;
//		String id = extractId(prefixEncodedPassword);
