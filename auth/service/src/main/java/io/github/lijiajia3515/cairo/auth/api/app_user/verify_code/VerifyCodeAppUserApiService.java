package io.github.lijiajia3515.cairo.auth.api.app_user.verify_code;
...
/**
 * [endpoint/api] 验证码 service
 */
@Slf4j
@Component
public class VerifyCodeAppUserApiService {
	...
	public VerifyCodeAppUserApiService(VerifyCodeService verifyCodeService,
	...
	public void sendMyAccountPhoneNumberVerifyCode(@Valid @NotNull String appId) {
		String accountPhoneNumber = CairoSecurityContextHolder.getAppUser().map(CairoOAuthAppUserPrincipal::getAccountPhoneNumber).orElseThrow(() -> new ConflictBusinessException("未设置手机号"));
