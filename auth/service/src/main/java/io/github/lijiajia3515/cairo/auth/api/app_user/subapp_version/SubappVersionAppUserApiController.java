...
@BusinessResultBody
public class SubappVersionAppUserApiController {

	private final SubappVersionAppUserApiService subappVersionAppUserApiService;
	...
	public List<SubappVersion> getSubappVersionList(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal, @RequestBody(required = false) GetSubappVersionArgs args) {
		...
		return subappVersionAppUserApiService.getSubappVersionList(args);
	}
}
