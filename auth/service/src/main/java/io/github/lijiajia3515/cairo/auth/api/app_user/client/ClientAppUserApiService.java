package io.github.lijiajia3515.cairo.auth.api.app_user.client;
...
import io.github.lijiajia3515.cairo.auth.domain.api.app_user.client.GetCurrentAppClientArgs;
...
/**
 * [endpoint/api] client service
 */
@Slf4j
@Validated
@Component
public class ClientAppUserApiService {


	private final MongoTemplate readMongoTemplate;
	public ClientAppUserApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate) {
	...
	List<BasicClient> getClientList(@Valid @NotNull String appId, @Validated GetCurrentAppClientArgs args) {
