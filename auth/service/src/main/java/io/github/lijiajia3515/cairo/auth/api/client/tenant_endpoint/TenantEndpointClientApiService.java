...
/**
 * [client/api] tenant app endpoint service
 */
@Slf4j
@Validated
@Component
public class TenantEndpointClientApiService {
	...
	public TenantEndpointClientApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
