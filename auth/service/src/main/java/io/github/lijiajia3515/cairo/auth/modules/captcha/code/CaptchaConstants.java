...
public class CaptchaConstants {
	...
	public static final CodeGenerator DEFAULT_CODE_GENERATOR = new RandomGenerator(BASE_NUMBER, 4);
	public static final CodeGenerator NUMBER_CODE_GENERATOR = new RandomGenerator(BASE_NUMBER, 4);
	public static final CodeGenerator ENGLISH_CODE_GENERATOR = new RandomGenerator(BASE_CHAR.toUpperCase(), 4);
	public static final CodeGenerator CHINESE_CODE_GENERATOR = new RandomGenerator(new String(MODERN_CHINESE), 3);
	public static final CodeGenerator MATH_CODE_GENERATOR = new CairoMathGenerator(2);

	public static CodeGenerator getCodeGenerator(CairoCaptchaType type) {
		CodeGenerator generator = DEFAULT_CODE_GENERATOR;
		if (type == null) return generator;
		switch (type) {
			case NUMBER:
				generator = NUMBER_CODE_GENERATOR;
				break;
			case ENGLISH:
				generator = ENGLISH_CODE_GENERATOR;
				break;
			case CHINESE:
				generator = CHINESE_CODE_GENERATOR;
				break;
			case MATH:
				generator = MATH_CODE_GENERATOR;
				break;
		}
		return generator;
	}
