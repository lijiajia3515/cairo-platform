...
@BusinessResultBody
public class AccountLoginLogCairoEndpointUserApiController {

	private final AccountLoginLogCairoEndpointUserApiService accountLoginLogCairoEndpointUserApiService;
	...
	public Page<AccountLoginLog> getAccountLoginLogPageList(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal,
		...
		return accountLoginLogCairoEndpointUserApiService.getAccountLoginLogPageList(appId, clientId, Optional.ofNullable(args).orElse(GetAccountLoginLogArgs.builder().build()));
	}
