...
@Validated
@Component
public class AccountLoginLogCairoWebManageApiService {
	...
	public AccountLoginLogCairoWebManageApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
