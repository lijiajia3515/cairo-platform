...
@BusinessResultBody
public class EndpointTenantAppUserApiController {

	private final EndpointTenantAppUserApiService endpointTenantAppUserApiService;
	...
	public List<Endpoint> getEndpointList(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal, @RequestBody(required = false) GetEndpointArgs args) {
		...
		return endpointTenantAppUserApiService.getEndpointList(principal.getAppId(), args);
	}
}
