package io.github.lijiajia3515.cairo.auth.api.app_user.subapp;
...
import io.github.lijiajia3515.cairo.auth.domain.api.app_user.subapp.GetSubappArgs;
...
@BusinessResultBody
public class SubappAppUserApiController {

	private final SubappAppUserApiService subappAppUserApiService;
	...
	public List<Subapp> getSubappList(@AuthenticationPrincipal CairoOAuthAppUserPrincipal principal, @RequestBody(required = false) GetSubappArgs args) {
		...
		return subappAppUserApiService.getSubappList(principal.getAppId(), args);
	}
}
