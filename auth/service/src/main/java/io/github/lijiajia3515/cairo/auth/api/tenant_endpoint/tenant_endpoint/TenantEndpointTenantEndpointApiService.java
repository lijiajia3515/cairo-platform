...
/**
 * [tenant_app_user/api] tenant app endpoint service
 */
@Slf4j
@Validated
@Component
public class TenantEndpointTenantEndpointApiService {
	...
	public TenantEndpointTenantEndpointApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
