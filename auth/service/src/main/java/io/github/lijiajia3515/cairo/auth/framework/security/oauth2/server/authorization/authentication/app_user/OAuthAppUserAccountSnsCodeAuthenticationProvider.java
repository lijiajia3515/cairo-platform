...
import static io.github.lijiajia3515.cairo.auth.framework.security.oauth2.core.OAuthAppUserAuthorizationGrantTypes.ACCOUNT_SNS_CODE;
 ...
 */
@Slf4j
public final class OAuthAppUserAccountSnsCodeAuthenticationProvider implements AuthenticationProvider {
	 ...
	 * @since 0.2.3
	 */
	public OAuthAppUserAccountSnsCodeAuthenticationProvider(AuthenticationManager authenticationManager, AppUserAuthorizationService authorizationService, OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator) {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		OAuthAppUserAccountSnsCodeAuthenticationToken token = (OAuthAppUserAccountSnsCodeAuthenticationToken) authentication;
		...
		CairoAppUserAccountSnsCodeAuthenticationToken authenticationToken = new CairoAppUserAccountSnsCodeAuthenticationToken(
		...
		if (userAuthentication == null || !(userAuthentication.getPrincipal() instanceof CairoAuthAppUser)) {
			throw new OAuth2AuthenticationException(
				new OAuth2Error(
		...
		CairoAuthAppUser user = (CairoAuthAppUser) userAuthentication.getPrincipal();
	...
	public boolean supports(Class<?> authentication) {
		return OAuthAppUserAccountSnsCodeAuthenticationToken.class.isAssignableFrom(authentication);
	}
