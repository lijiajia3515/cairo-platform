...
@Validated
@Component
public class TenantAppUserAuthorizationTenantEndpointApiService {
	...
	public TenantAppUserAuthorizationTenantEndpointApiService(@Qualifier("mongoTemplate") MongoTemplate mongoTemplate,
