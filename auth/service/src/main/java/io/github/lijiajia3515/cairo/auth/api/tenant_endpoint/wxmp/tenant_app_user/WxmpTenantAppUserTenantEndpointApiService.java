...
@Validated
@Component
public class WxmpTenantAppUserTenantEndpointApiService {
	...
	public WxmpTenantAppUserTenantEndpointApiService(@Qualifier("mongoTemplate") MongoTemplate mongoTemplate,
