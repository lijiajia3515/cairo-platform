...
/**
 * [endpoint/api] action permission service
 */
@Slf4j
@Validated
@Component
public class PermissionSubappApiService {

	private final MongoTemplate readMongoTemplate;
	private final MenuCommonService menuCommonService;

	public PermissionSubappApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate,
