...
@Slf4j
public class CairoAccountPreAuthenticationChecks implements UserDetailsChecker {
	@Setter
	protected MessageSourceAccessor messages = SpringSecurityMessageSource.getAccessor();
	@Override
	public void check(UserDetails user) {
		if (user instanceof CairoAuthAccount){
			CairoAuthAccount account = (CairoAuthAccount) user;
