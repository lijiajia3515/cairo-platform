...
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.tenant_app_user.TenantAppUserLogoffStatusInfo;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.tenant_app_user.ModifyMyTenantAppUserInfoArgs;
import io.github.lijiajia3515.cairo.auth.domain.api.tenant_endpoint.tenant_app_user.UserInfo;
...
@BusinessResultBody
public class TenantAppUserTenantEndpointApiController {

	private final CairoAuthTenantAppUserService cairoAuthTenantAppUserService;
	private final TenantAppUserTenantEndpointApiService tenantAppUserTenantEndpointApiService;
	...
	public Optional<String> modifyMyTenantAppUserInfo(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal,
		...
		tenantAppUserTenantEndpointApiService.modifyMyTenantAppUserInfo(tenantId, appId, userId, args);
	...
	public TenantAppUserLogoffStatusInfo getMyTenantAppUserLogoffStatus(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		...
		String appId = principal.getAppId();
		String userId = principal.getUserId();
		return tenantAppUserTenantEndpointApiService.getMyTenantAppUserLogoffStatus(tenantId, appId, userId);
	}
	...
	public PreLogoffInfo getMyTenantAppUserPreLogoffInfo(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		...
		String appId = principal.getAppId();
		String userId = principal.getUserId();
		return tenantAppUserTenantEndpointApiService.getMyTenantAppUserPreLogoffInfo(tenantId, appId, userId);
	}
	...
	public Optional<MetadataTenantAppUser> logoffMyTenantAppUser(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		...
		String appId = principal.getAppId();
		String userId = principal.getUserId();
		tenantAppUserTenantEndpointApiService.logoffMyTenantAppUser(tenantId, appId, userId);
		return Optional.empty();
	}
	...
	public Optional<MetadataTenantAppUser> unlogoffMyTenantAppUser(@AuthenticationPrincipal CairoOAuthTenantAppUserPrincipal principal) {
		...
		String appId = principal.getAppId();
		String userId = principal.getUserId();
		tenantAppUserTenantEndpointApiService.unlogoffMyTenantAppUser(tenantId, appId, userId);
		return Optional.empty();
	}
}
