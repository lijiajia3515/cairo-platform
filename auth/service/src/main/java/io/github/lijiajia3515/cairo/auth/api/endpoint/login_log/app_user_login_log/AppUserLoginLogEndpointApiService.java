...
/**
 * [endpoint/api] app endpoint user login log service
 */
@Slf4j
@Validated
@Component
public class AppUserLoginLogEndpointApiService {
	private final MongoTemplate readMongoTemplate;

	private final EndpointCommonService endpointCommonService;
	private final ClientCommonService clientCommonService;

	public AppUserLoginLogEndpointApiService(@Qualifier("readMongoTemplate") MongoTemplate readMongoTemplate, EndpointCommonService endpointCommonService, ClientCommonService clientCommonService) {
