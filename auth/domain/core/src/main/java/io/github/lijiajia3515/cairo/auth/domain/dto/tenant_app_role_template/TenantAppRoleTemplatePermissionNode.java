...
@AllArgsConstructor
@Builder
public class TenantAppRoleTemplatePermissionNode implements TreeNode2<String, TenantAppRoleTemplatePermissionNode>, Serializable {
	/**
	 * 菜单Id
	 */
	...
	@Builder.Default
	private List<TenantAppRoleTemplatePermissionNode> menus = new ArrayList<>(1);
	...
	@Override
	public List<TenantAppRoleTemplatePermissionNode> subs() {
		return menus;
	}

	@Override
	public void subs(List<TenantAppRoleTemplatePermissionNode> subs) {
		this.menus = subs;
	}
