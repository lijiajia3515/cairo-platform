...
const [configs] = useState({
  ...
  columns: [
    ...
    avatarCopyColumn({colKey: 'user.nickname', title: '用户', iconKey: 'user.accountAvatarUrl', copyKey: 'userId'}),
...
const getServiceLog = debounce(async () => {
  ...
  try {
    ...
    let res = await getAppBizLogPage_api(params, headers);
    if (res.code == 'Success') {
