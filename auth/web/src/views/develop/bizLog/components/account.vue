...
const [configs] = useState({
  ...
  columns: [
    ...
    avatarCopyColumn({colKey: 'account.nickname', title: '账号', iconKey: 'account.avatarUrl', copyKey: 'accountId'}),
...
const getServiceLog = async () => {
  ...
  try {
    ...
    let res = await getAccountBizLogPage_api(params, headers);
    if (res.code == 'Success') {
...
<template>
  <div class="accountComponent">
    ...
    <FilterBar @search="onSearch" @reset="onReset">
      ...
      <FilterItem label="账号">
        <t-select filterable clearable v-model="search.accountId" placeholder="账号">
