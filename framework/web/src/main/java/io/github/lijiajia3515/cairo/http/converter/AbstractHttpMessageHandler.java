...
public class AbstractHttpMessageHandler implements BeanPostProcessor {
	...
	protected AbstractHttpMessageHandler(List<HttpMessageConverter<?>> converters,
	...
	protected void writeWithMessageConverters(@Nullable Object value, ServletServerHttpRequest inputMessage, ServletServerHttpResponse outputMessage)
		...
		if (isResourceType(valueType)) {
			...
			if (inputMessage.getHeaders().getFirst(HttpHeaders.RANGE) != null &&
	...
	protected boolean isResourceType(Class<?> valueType) {
		return valueType != InputStreamResource.class && Resource.class.isAssignableFrom(valueType);
	}
	...
	public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
		if (bean instanceof ContentNegotiationManager) {
			this.contentNegotiationManager = (ContentNegotiationManager) bean;
			this.safeExtensions.addAll(this.contentNegotiationManager.getAllFileExtensions());
		}
		return bean;
	}
