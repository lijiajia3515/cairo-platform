...
import io.github.lijiajia3515.cairo.gateway.framework.gateway.filter.rewrite.BusinessResultFunction;
...
public class BusinessResultGatewayFilterFactory extends AbstractGatewayFilterFactory<BusinessResultGatewayFilterFactory.Config> {
	...
	public BusinessResultGatewayFilterFactory(List<HttpMessageReader<?>> messageReaders,
	...
	public static class Config {
		...
		private RewriteFunction rewriteFunction = new BusinessResultFunction();
