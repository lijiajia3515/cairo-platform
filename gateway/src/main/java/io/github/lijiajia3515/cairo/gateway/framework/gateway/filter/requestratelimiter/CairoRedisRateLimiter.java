...
@Slf4j
public class CairoRedisRateLimiter extends AbstractRateLimiter<CairoRedisRateLimiter.Config> implements ApplicationContextAware {
	...
	public CairoRedisRateLimiter(ReactiveStringRedisTemplate redisTemplate, RedisScript<List<Long>> script,
								 ConfigurationService configurationService,String configurationPropertyName) {
		super(Config.class, configurationPropertyName, configurationService);
	 ...
	 * algorithm.
	 */
	public CairoRedisRateLimiter(int defaultReplenishRate, int defaultBurstCapacity) {
	 ...
	 */
	public CairoRedisRateLimiter(int defaultReplenishRate, int defaultBurstCapacity, int defaultRequestedTokens) {
