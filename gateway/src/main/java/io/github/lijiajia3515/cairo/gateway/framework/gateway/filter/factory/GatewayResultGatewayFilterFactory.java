...
import io.github.lijiajia3515.cairo.gateway.framework.gateway.filter.rewrite.GatewayBusinessResultFunction;
...
public class GatewayResultGatewayFilterFactory extends AbstractGatewayFilterFactory<GatewayResultGatewayFilterFactory.Config> {
	...
	public GatewayResultGatewayFilterFactory(List<HttpMessageReader<?>> messageReaders,
	...
	public static class Config {
		...
		private Class inClass = Object.class;

		private Class outClass = Object.class;
		...
		private RewriteFunction rewriteFunction = new GatewayBusinessResultFunction();
	...
	protected class ModifiedServerHttpResponse extends ServerHttpResponseDecorator {
		...
		public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
			...
			if (originalResponseContentType != null) {
				boolean flag = messageReaders.stream()
					.anyMatch(x -> x.canRead(ResolvableType.forClass(outClass), MediaType.valueOf(originalResponseContentType)));
				if (flag) {
